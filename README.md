...
<head>
    ...
    <title>Language Expertise</title>
    <style>
        body {
            margin: 0;
            padding: 20px;
            background: linear-gradient(135deg, #1a1b27 0%, #24283b 100%);
        ...
        /* Language-specific colors and styling */
        .verilog { border-left-color: #ff6b35; }
        .verilog .progress-fill { background: linear-gradient(90deg, #ff6b35, #ff8c42); }
        .verilog .rank { color: #ff6b35; }
        
        .systemverilog { border-left-color: #e31837; }
        .systemverilog .progress-fill { background: linear-gradient(90deg, #e31837, #ff1744); }
        .systemverilog .rank { color: #e31837; }
        
        .python { border-left-color: #3776ab; }
        .python .progress-fill { background: linear-gradient(90deg, #3776ab, #4791db); }
        .python .rank { color: #3776ab; }
        
        .cpp { border-left-color: #00599c; }
        .cpp .progress-fill { background: linear-gradient(90deg, #00599c, #0073e6); }
        .cpp .rank { color: #00599c; }
        
        .embeddedc { border-left-color: #00979d; }
        .embeddedc .progress-fill { background: linear-gradient(90deg, #00979d, #26c6da); }
        .embeddedc .rank { color: #00979d; }
        
        .tcl { border-left-color: #1f425f; }
        .tcl .progress-fill { background: linear-gradient(90deg, #1f425f, #455a64); }
        .tcl .rank { color: #78909c; }
        
        .assembly { border-left-color: #525252; }
        .assembly .progress-fill { background: linear-gradient(90deg, #525252, #757575); }
        .assembly .rank { color: #9e9e9e; }
...
<body>
    <div class="expertise-container">
        ...
        <div class="language-item verilog">
            <div class="language-info">
                <span class="rank medal">🥇</span>
                <span class="language-name">Verilog</span>
            </div>
            <div style="text-align: right;">
                <div class="proficiency">95%</div>
        ...
        <div class="language-item systemverilog">
            <div class="language-info">
                <span class="rank medal">🥈</span>
                <span class="language-name">SystemVerilog</span>
            </div>
            <div style="text-align: right;">
                <div class="proficiency">88%</div>
                <div class="progress-bar">
        ...
        <div class="language-item embeddedc">
            <div class="language-info">
                <span class="rank">5</span>
                <span class="language-name">Embedded C</span>
            </div>
            <div style="text-align: right;">
                <div class="proficiency">75%</div>
                <div class="progress-bar">
        ...
        <div class="language-item tcl">
            <div class="language-info">
                <span class="rank">6</span>
                <span class="language-name">Tcl</span>
            </div>
            <div style="text-align: right;">
                <div class="proficiency">65%</div>
                <div class="progress-bar">
        ...
        <div class="language-item assembly">
            <div class="language-info">
                <span class="rank">7</span>
                <span class="language-name">Assembly</span>
            </div>
            <div style="text-align: right;">
                <div class="proficiency">60%</div>
                <div class="progress-bar">
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white&labelColor=0077B5)](https://linkedin.com/in/apratimphadke)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white&labelColor=D14836)](mailto:apratimphadke@gmail.com)
...
[![Portfolio](https://img.shields.io/badge/Portfolio-FF6B35?style=for-the-badge&logo=web&logoColor=white&labelColor=FF6B35)](https://apratimphadke.dev)
